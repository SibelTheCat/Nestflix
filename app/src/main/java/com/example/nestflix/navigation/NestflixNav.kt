...
fun NestflixNavigation(){
    ...
    NavHost(navController = navController, startDestination = NestflixScreens.HomeScreen.name){
        ...
        composable(route = NestflixScreens.GalleryScreen.name){ GalleryScreen(navController = navController, birdNoteViewModel= birdNoteViewModel, birdnotelist = birdNoteViewModel.getAllBirdNotes())}
    }
